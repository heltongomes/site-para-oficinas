...
----------- | ----------- | ----------- 
<img src="{{ '/images/descartes-dioptrica-p460.svg' | absolute_url }}" alt="github octocat" style="width:45%;" > | texto linha 1 x coluna 3 [Reference page]({{ "/5-reference.html" | absolute_url }}) | <img src="{{ '/images/jekyll.png' | absolute_url }}" alt="jekyll icon" style="width:45%;" >
